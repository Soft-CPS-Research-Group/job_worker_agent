...
RUN apt-get update \
    ...
    && case "$arch" in \
        ...
        *) echo "Unsupported ORAS architecture: $arch" >&2; exit 1 ;; \
    esac \
    && curl -sSL "https://github.com/oras-project/oras/releases/download/v${ORAS_VERSION}/oras_${ORAS_VERSION}_linux_${oras_arch}.tar.gz" -o /tmp/oras.tgz \
